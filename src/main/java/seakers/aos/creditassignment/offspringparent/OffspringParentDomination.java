...
public class OffspringParentDomination extends AbstractOffspringParent {
     ...
     * @param rewardNoOneDominates Reward that is assigned if neither the
     * offspring or parent dominates the other
     * @param problemComparator Comparator used in the problem, can be ParetoDominanceComparator or
     * a ChainedComparator
     */
    public OffspringParentDomination(double rewardOffspringDominates, double rewardNoOneDominates, double rewardParentDominates, DominanceComparator problemComparator) {
        super();
        this.creditOffspringDominates = rewardOffspringDominates;
        this.creditParentDominates = rewardParentDominates;
        this.creditNoOneDominates = rewardNoOneDominates;
        this.comp = problemComparator;
    }
