    ...
    protected void iterate() {
        ...
        if (recordAllSolutions) {
            for (Solution soln : ea.getPopulation()) {
                ...
                String className = soln.getClass().getName();
                if (className.equalsIgnoreCase("seakers.vassarexecheur.search.problems.partitioning.PartitioningArchitecture") || className.equalsIgnoreCase("seakers.vassarexecheur.search.problems.assigning.AssigningArchitecture")) {
