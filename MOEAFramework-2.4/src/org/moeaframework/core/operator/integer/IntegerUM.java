...
/**
 * Uniform mutation (InetgerUM) operator for integer variables. Each decision
 * variable is mutated by selecting a new value within its bounds uniformly at
 * random. The figure below depicts the offspring distribution.
 * <p>
 ...
 */
public class IntegerUM implements Variation, Serializable {
